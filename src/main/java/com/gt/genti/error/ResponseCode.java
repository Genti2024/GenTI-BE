...
public enum ResponseCode {
	...
	TOKEN_REFRESH_FAILED(false, HttpStatus.INTERNAL_SERVER_ERROR, ErrorConstants.TOKEN_REFRESH_FAILED, "토큰 갱신에 실패했습니다."),
	...
	// QueryParameterNotGiven(false, HttpStatus.BAD_REQUEST, ErrorConstants.QueryParameterNotGiven, "%s"),
	...
	MissingPathVariableException(false, HttpStatus.BAD_REQUEST, ErrorConstants.MissingPathVariableException,
		"query param 에러 %s "),
	ActivePictureGenerateRequestNotExists(false, HttpStatus.NOT_FOUND, ErrorConstants.ActivePictureGenerateRequestNotExists,
		"현재 진행중인 요청이 없습니다."),
	...
	RequestAlreadyInProgress(false, HttpStatus.BAD_REQUEST, ErrorConstants.RequestAlreadyInProgress,
		"이미 작업이 진행중인 요청은 수정이 불가합니다."),
	// ZeroMatchingRequests(false, HttpStatus.NO_CONTENT, ErrorConstants.ZeroMatchingRequests, "매칭된 요청이 없습니다."),
	...
	NotSupportedTemp(false, HttpStatus.BAD_REQUEST, ErrorConstants.NotSupportedTemp, "지원되지않는 조회조건입니다."),
	...
	NotAssignedToMe(false, HttpStatus.BAD_REQUEST, ErrorConstants.NotAssignedToMe, "현재 공급자에게 매칭된 요청이 아닙니다."),
	NotMatchedYet(false, HttpStatus.BAD_REQUEST, ErrorConstants.NotMatchedYet, "아직 매칭되지 않은 요청을 조회할 수 없습니다."),
	ExpiredPictureGenerateRequest(false, HttpStatus.BAD_REQUEST, ErrorConstants.ExpiredPictureGenerateRequest,
		"제출 마감 시간을 초과하였습니다."),
	ExpiredMatching(false, HttpStatus.BAD_REQUEST, ErrorConstants.ExpiredMatching, "수락 마감 시간을 초과하였습니다."),
	...
	CannotRestoreUser(false, HttpStatus.BAD_REQUEST, ErrorConstants.CannotRestoreUser, "탈퇴 후 한달이 지난 경우 재가입해야합니다."),
	PictureUserFaceNotFound(false, HttpStatus.NOT_FOUND, ErrorConstants.PictureUserFaceNotFound, "유저의 얼굴 사진을 찾지 못했습니다."),
	PicturePoseNotFound(false, HttpStatus.NOT_FOUND, ErrorConstants.PicturePoseNotFound, "포즈 참고 사진을 찾지 못했습니다."),
	PictureCompletedNotFound(false, HttpStatus.NOT_FOUND, ErrorConstants.PictureCompletedNotFound, "최종 완성 사진을 찾지 못했습니다."),
	...
	OnlyRequesterCanViewRequest(false, HttpStatus.FORBIDDEN, ErrorConstants.OnlyRequesterCanViewRequest,
		"사진생성요청을 요청한 유저만 볼 수 있습니다."),
	NotAllowedOauthProvider(false, HttpStatus.NOT_ACCEPTABLE, ErrorConstants.NotAllowedOauthProvider,
		"허가되지 않은 oauth type %s"),
	UserNotLoggedIn(false, HttpStatus.UNAUTHORIZED, ErrorConstants.UserNotLoggedIn, "로그아웃되었습니다. 다시 로그인해주세요"),
	PGRESStateException(false, HttpStatus.NOT_ACCEPTABLE, ErrorConstants.PGRESStateException,
	...
	NoSettlementForWithdrawalException(false, HttpStatus.BAD_REQUEST, ErrorConstants.NoSettlementForWithdrawalException,
		"출금 가능한 정산 내역이 없습니다."),
	AlreadyCompletedResponse(false, HttpStatus.BAD_REQUEST, ErrorConstants.AlreadyCompletedResponse,
		"이미 처리 완료된 응답입니다."),
	WithdrawRequestNotFound(false, HttpStatus.NOT_FOUND, ErrorConstants.WithdrawRequestNotFound, "해당 출금 요청을 찾을 수 없습니다."),
	NotEnoughBalance(false, HttpStatus.NOT_ACCEPTABLE, ErrorConstants.NotEnoughBalance,
		"해당 공급자의 출금가능 잔액이 부족하여 요청을 완료할 수 없습니다."),
	NoPendingUserVerificationPGREQ(false, HttpStatus.NOT_FOUND, ErrorConstants.NoPendingUserVerificationPGREQ,
		"현재 사용자의 확인 대기중인 사진생성요청이 없습니다."),
