...
public enum ResponseCode {
	...
	TOKEN_REFRESH_FAILED(false, HttpStatus.UNAUTHORIZED, ErrorConstants.TOKEN_REFRESH_FAILED,
		"토큰 갱신에 실패했습니다."),
	INVALID_REFRESH_TOKEN(false, HttpStatus.UNAUTHORIZED, ErrorConstants.INVALID_REFRESH_TOKEN,
		"토큰 갱신에 실패했습니다."),
	Forbidden(false, HttpStatus.FORBIDDEN, ErrorConstants.Forbidden,
		"토큰 갱신에 실패했습니다."),
	UnAuthorized(false, HttpStatus.UNAUTHORIZED, ErrorConstants.UnAuthorized,
		"인증되지 않은 사용자."),
	 ...
	 * Creator
	 */
	CreatorNotFound(false, HttpStatus.NOT_FOUND, ErrorConstants.CreatorNotFound, "userId [%d] 에 해당하는 공급자를 찾을 수 없습니다."),
