package com.gt.genti.openai.service;
...
public class OpenAIService {
	...
	public String extractAdvancedPrompt(PromptAdvancementResponse promptAdvancementResponse) {
		return promptAdvancementResponse.getChoices().get(0).getMessage().getContent();
	}
