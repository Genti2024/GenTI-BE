...
@Schema(name = "[PGREQ][Admin] 공급자->어드민(얼굴붙여야하는작업) 사진생성요청 조회 by 어드민 응답 dto")
@Getter
@NoArgsConstructor(access = AccessLevel.PROTECTED)

public class PGREQCreatorSubmittedDetailFindByAdminResponseDto {
	...
	@Builder
	public PGREQCreatorSubmittedDetailFindByAdminResponseDto(Long pictureGenerateRequestId, String requesterEmail,
		...
		LocalDateTime createdAt, List<PGRESCreatorSubmittedDetailFindByAdminResponseDto> responseList) {
