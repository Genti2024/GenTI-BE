...
public class PGREQReportController {
	...
	@PostMapping("")
	public ResponseEntity<GentiResponse.ApiResult<Boolean>> createReport(
		@AuthUser Long userId,
		@RequestBody @Valid ReportCreateRequestDto reportCreateRequestDto
	) {
		return GentiResponse.success(reportService.createReport(userId, reportCreateRequestDto));
	}
